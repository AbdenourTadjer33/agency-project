<x-app-layout>
    <x-slot:title>Accueil - Best Tour</x-slot:title>
    ...
    <div class="slideshow-container">
        <div class="mySlides fade">
            <img src="{{ asset('storage/banner/1.jpg') }}" style="width:100%">
        </div>

        <div class="mySlides fade">
            <img src="{{ asset('storage/banner/2.jpg') }}" style="width:100%">
        </div>

        <div class="mySlides fade">
            <img src="{{ asset('storage/banner/3.jpg') }}" style="width:100%">
        </div>
    ...
    <div class="p-5 space-y-5">
        <div>
            <h1
                class="capitalize text-5xl p-4 text-center font-bold bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent mb-2">
                Nos Hôtels
            </h1>
                    ...
                    <div
                        ...
                        <div class="p-5 space-y-2">
                            <a href="{{ route('trip.show', ['slug' => $trip->slug]) }}">
                                <h5
                                    class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white capitalize">
                                    {{ $trip->name }}
                                </h5>
                            </a>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.0"
                                    class="w-5 h-5 text-gray-800 dark:text-white me-2"
    ...
    <div class="my-5">
        <div class="m-auto">
            <h2 class="text-center text-2xl text-slate-900 font-semibold">Nous sommes sur les réseaux sociaux</h2>
            <div class="mt-4 flex justify-center items-center gap-4">
                <div title="twitter">
                    <a href="https://twitter.com" rel="noreferrer" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-10 h-10 text-slate-900 transition duration-300 hover:text-green-500"
                ...
                <div title="facebook">
                    <a href="https://facebook.com" rel="noreferrer" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"
                            class="w-10 h-10 text-slate-900 transition duration-300 hover:text-blue-500"
                            fill="currentColor">
                ...
                <div title="instagram">
                    <a href="https://instagram.com" rel="noreferrer" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"
                            class="w-10 h-10 text-slate-900 transition duration-300 hover:text-pink-500"
                            fill="currentColor">
                            <rect width="256" height="256" fill="none" />
    ...
    <div class="p-5">
        <div class="text-center font-medium text-base 4">
            Best Tours votre Agence de Voyage en Algérie vous propose des Promotions sur vos Voyages et Séjours <br>en
            Algérie et dans le Monde avec les Meilleurs Prix et Services.
        </div>
    </div>
</x-app-layout>
