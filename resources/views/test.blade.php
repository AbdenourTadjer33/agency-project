...
<body>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-start rtl:justify-end">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        ...
                        class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg 3xl:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 3xl:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar">
    ...
    <main class="p-4 3xl:ml-64 mt-14">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus vel laborum soluta optio amet doloremque
        sapiente voluptate porro debitis? Repellat dolores sint minus ex! Facilis minima culpa atque ipsa qui!
    </main>
