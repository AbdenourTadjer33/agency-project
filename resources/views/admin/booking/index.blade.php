                    ...
                    <tr
                        ...
                        <td class="px-2 py-4">
                            @if ($booking->status)
                                <div class="flex items-center">
                                    <div class="h-2.5 w-2.5 rounded-full {{ $booking->status == 'validé' ? 'bg-green-500' : 'bg-red-500' }} me-2"></div>
                                    {{ $booking->status }}
                                </div>
                            @endif
                        </td>
                        ...
                        <td class="px-2 py-4">
                            ...
                            <button
                                ...
                                type="button">
                                <a href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.0" class="w-4 text-purple-200"
                                        fill="currentColor" viewBox="0 0 512.000000 512.000000">
                            ...
                            <button data-modal-target="delete-booking-modal-{{ $booking->id }}"
                                ...
                                type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 text-red-400" fill="currentColor"
                                    viewBox="0 0 256 256">
                                    <path
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                ...
                                                <span class="text-black font-medium">{{ $booking->type }}</span>?
                                            </h3>
                                            <div class="flex gap-1 justify-center items-center">
                                                <form method="post"
                                                    action="{{ route('booking.delete', ['ref' => $booking->ref]) }}">
                                                    @csrf @method('delete')
                                                    <button data-modal-hide="delete-booking-modal-{{ $booking->id }}"
                                                        type="submit"
