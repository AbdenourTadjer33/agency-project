<x-app-layout>
    <x-slot:title>{{ $trip->name }}</x-slot:title>
    ...
    <div class="text-center text-2xl font-bold mt-4">TRIP DATA</div>
    @dump($trip)
        ...
        <form class="px-10 py-6" id="book-trip" method="post">
            ...
            <div class="grid gap-5 mb-4 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <div id="price" class="text-center justify-center items-center text-2xl font-extrabold pb-2.5 text-slate-800 ">
